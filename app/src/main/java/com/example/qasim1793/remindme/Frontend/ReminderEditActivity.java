...
public class ReminderEditActivity extends AppCompatActivity implements
    ...
    private TextView mDateText, mTimeText, mRepeatText, mRepeatNoText, mRepeatTypeText,locationNameText;
    private FloatingActionButton mFAB1;
    private FloatingActionButton mFAB2;
    private Switch mRepeatSwitch,mFavSwitch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFavSwitch = (Switch) findViewById(R.id.fav_switch);
        categorySpinner = (Spinner) findViewById(R.id.categorySpinner);
        locationLayout = (RelativeLayout) findViewById(R.id.locationLayout);
        locationNameText = (TextView) findViewById(R.id.location_name_selected);
        ...
        mCate = mReceivedReminder.getReminderCategory();
        mFav = mReceivedReminder.getFavorite();
        locationTitle = mReceivedReminder.getLocationTitle();
        lat = mReceivedReminder.getLat();
        lng = mReceivedReminder.getLng();
        ...
        final ArrayAdapter<String> companyDataAdapter = new ArrayAdapter<String>(this,
                android.R.layout.simple_spinner_item, category);
        companyDataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        this.categorySpinner.setAdapter(companyDataAdapter);

        categorySpinner.setSelection(category.indexOf(mCate));


        if(mFav.equalsIgnoreCase("true")){
        ...
        locationLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ReminderEditActivity.this,AddLocationToReminder.class);
                intent.putExtra("lat",ReminderEditActivity.this.lat);
                intent.putExtra("lng",ReminderEditActivity.this.lng);
...
//    }
    ...
    public void updateReminder(){
        ...
        mCate = categorySpinner.getSelectedItem().toString();
        ...
        mReceivedReminder.setFavorite(mFav);
        mReceivedReminder.setReminderCategory(mCate);
